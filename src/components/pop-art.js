...
//   COUNTRYNAMES
// } from '../mock/task.js';
// import {createRandomFilm} from '../components/film-card-task.js';

// поп-арт - закоментировал тут и в main.js, т.к он контент закрывает
export const createPopArtFilmlsTaskTemplate = function (pop) {
  const {original, poster, name, rating, time, comments, watched, favorite, watchlist, age, director, writers, actors, release, countrynames, ganrePop, fullDescription} = pop;
  return (
