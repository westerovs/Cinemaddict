...
const createFilmCardTaskTemplate = () => (
...
// поп-арт - закоментировал тут и внизу, т.к он контент закрывает(они бы там хоть имя файла указали. Они там все одинаковые)
// TASK поп арт фильма
// const createFilmDtailsTaskTemplate = () => (
...
// поп-арт - закоментировал тут и вверху, т.к он всё закрывает(они бы там хоть имя файла указали. Они там все одинаковые)
// const siteBodyElement = document.querySelector(`body`);
// const popElement = siteBodyElement.querySelector(`footer`);
// render(popElement, createFilmDtailsTaskTemplate(), `afterEnd`);
